...
public class ProductSearchDAO extends CassandraDataSearch {
    ...
    public ProductSearchDAO(Row row) {
    ...
    public static ProductSearchDAO getProductById(String productId) {
        ...
        return new ProductSearchDAO(resultSet.one());

    }

    public static List<ProductSearchDAO> getProductsByBrand(String brand_id) {
    ...
    public static List<ProductSearchDAO> getProductsByCategoryName(String category_name) {
    ...
    private static List<ProductSearchDAO> getProductsWithStmt(Statement statement) {
        ...
        final List<ProductSearchDAO> productSearchDAOList = new ArrayList<ProductSearchDAO>(initial_result_size);

        if (results != null) {
            for (Row row: results) {
                productSearchDAOList.add(new ProductSearchDAO(row));
            }
        }

        return productSearchDAOList;
    }

    public static List<ProductSearchDAO> getProductsSolrQuery(String solr_query) {
